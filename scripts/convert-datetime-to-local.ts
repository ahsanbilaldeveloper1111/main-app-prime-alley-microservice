 ...
 * 
 * Usage:
 *   ts-node scripts/convert-datetime-to-local.ts "2025-12-24 13:04:08 +04:00"
 *   ts-node scripts/convert-datetime-to-local.ts "2025-12-24 13:04:08 +04:00" "Asia/Karachi"
 * 
 * Or run without arguments to use the default example:
 *   ts-node scripts/convert-datetime-to-local.ts
 */
 ...
 * @param datetimeString - Datetime string in format "YYYY-MM-DD HH:mm:ss +HH:mm" (e.g., "2025-12-24 13:04:08 +04:00")
 * @param targetTimezone - Target timezone (default: "Asia/Karachi")
