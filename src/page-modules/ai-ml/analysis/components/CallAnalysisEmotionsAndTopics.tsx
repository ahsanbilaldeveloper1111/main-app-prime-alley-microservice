...
import { hasArrayData, hasData } from "@page-modules/ai-ml/analysis/analysisHelpers";
                    ...
                    <table className="table-bordered table-sm w-100">
                      ...
                      <tbody>
                        {chunksAnalysisData?.tags?.map((item: any) => {
                          const tagRowKey =
                            [item?.name, item?.percentage, item?.description]
                              .map(String)
                              .join("\u241e") || "tag";
                ...
                <div className="card-text w-100">
                  {hasQualificationFields ? (
                    <table className="table-bordered table-sm w-100">
                      ...
                      <tbody>
                        {Object.entries(qualificationFields).map(([qfKey, value]) => (
                          <tr key={qfKey}>
                            <td>{qfKey}</td>
