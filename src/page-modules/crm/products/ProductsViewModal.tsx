    ...
    <>
      ...
      <div className="products-view-grid">
        ...
        {(product.industry || product.industry_id) && (
          <ProductDetailTile label="Product Group">
            <Badge bg="primary" className="bg-opacity-10 text-dark products-view-badge">
        ...
        <ProductDetailTile label="SKU">
          <Badge bg="light" text="dark" className="font-monospace products-view-badge">
            {product.sku}
          </Badge>
        </ProductDetailTile>
      ...
      <div className="products-view-grid">
        <ProductDetailTile label="Category">
          <Badge bg="info" className="bg-opacity-10 text-dark products-view-badge">
...
function ProductsViewModal({
  ...
  const industryLabel =
    ...
    "N/A";
  const footer = (
    <ProductsViewFooter canEditProduct={canEditProduct} onEdit={onEdit} onHide={onHide} />
  );
  const content = (
    <ProductsViewContent product={product} industryLabel={industryLabel} />
  );
  ...
  return (
    <Modal show={show} onHide={onHide} size="xl" centered>
      ...
      <Modal.Body className="products-view-body border-0 pt-0">{content}</Modal.Body>
      <Modal.Footer className="border-0 products-view-footer">{footer}</Modal.Footer>
    </Modal>
  );
}
