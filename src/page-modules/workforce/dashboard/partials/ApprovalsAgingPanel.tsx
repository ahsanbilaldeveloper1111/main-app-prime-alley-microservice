...
const ApprovalsAgingPanel: React.FC<ApprovalsAgingPanelProps> = ({
  ...
  <div className="employees-dashboard__card">
    ...
    <div className="employees-dashboard__insights">
      <h4 className="employees-dashboard__insights-title">Aging Insights</h4>
      <div className="employees-dashboard__insights-stack">
        <div className="employees-dashboard__insight-callout">
          <div className="employees-dashboard__insight-callout-head">
            <span className="employees-dashboard__insight-callout-label">Total pending</span>
            <span className="employees-dashboard__insight-callout-value">{approvalsAgingTotal}</span>
          </div>
          <div className="employees-dashboard__insight-callout-detail">
            {approvalsAgingChartData
              .filter((bucket) => bucket.value > 0)
              .map((bucket) => `${bucket.name}: ${bucket.value}`)
              .join(" · ") || "No pending approvals in the selected period"}
          </div>
        </div>
      </div>
    </div>
