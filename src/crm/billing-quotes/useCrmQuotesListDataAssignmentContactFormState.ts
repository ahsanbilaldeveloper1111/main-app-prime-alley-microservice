...
/**
 * Shared modal / assignment / sidebar / contact-form state for CRM and billing
 * quotes list pages (duplicated block extracted for Sonar / DRY).
 */
export function useCrmQuotesListDataAssignmentContactFormState() {
