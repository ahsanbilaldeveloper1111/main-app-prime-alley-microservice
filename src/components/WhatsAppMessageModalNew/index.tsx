...
//
// 3. Use it in JSX:
//    <button onClick={() => setIsWhatsAppModalOpen(true)}>Log WhatsApp</button>
//
  ...
  return (
    ...
    gap: '0px',
      ...
      >
        ...
        >
          <div style={{ fontSize: '12px', color: '#718096', marginBottom: '6px', fontWeight: '300' }}>
            Contacted
          </div>
            ...
            {showContactInput ? (
              ...
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  fontSize: '13px',
                  color: contacts.length === 0 ? '#414141' : '#4a5568',
                  padding: '2px 4px',
                  fontWeight: contacts.length === 0 ? '500' : '600',
                  fontFamily: 'inherit',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ padding: '20px', flex: 1 }}>
          <textarea
            ref={textareaRef}
            placeholder="Describe the WhatsApp message..."
            value={messageText}
