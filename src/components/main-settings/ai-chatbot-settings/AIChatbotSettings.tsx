    ...
    >
      {showCompanyFilter ? (
        <CompanyFilterBar
          ...
          onCompanySelect={handleCompanySelect}
          onApplyFilter={handleApplyFilter}
          appliedCompanyLabel={viewingCompanyLabel}
        />
      ) : viewingCompanyLabel ? (
        <p className="ai-chatbot-settings__company-active">
          Viewing: <strong>{viewingCompanyLabel}</strong>
        </p>
      ) : null}
        ...
        <>
          ...
          <div className="ai-chatbot-settings__section">
            ...
            <p className="ai-chatbot-settings__hint mb-3">
              Margin is added on top of base LLM cost when computing
              tenant-facing rates and thread costs. Leave blank for no margin.
              Tenants only see effective prices on the dashboard, not this
              percentage or base costs.
            </p>
