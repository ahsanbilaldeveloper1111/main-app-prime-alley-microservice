...
function RollupTable(props: Readonly<{
  ...
  return (
    <div className="ai-analysis-monthly-rollup__table-wrap">
      <Table hover responsive className="ai-analysis-monthly-rollup__table mb-0">
        <thead>
          <tr>
    ...
    <div className="ai-analysis-monthly-rollup">
      <header>
        ...
        <p className="ai-analysis-monthly-rollup__subheading">
          Per-tenant monthly call volume, cost, and outcome breakdown. Use filters to
          narrow by company, year, or month.
        </p>
      </header>

      <div className="ai-analysis-monthly-rollup__filters">
        <div className="ai-analysis-monthly-rollup__company-select">
          <span className="ai-analysis-monthly-rollup__field-label">Company</span>
          <Select<CompanySelectOption>
            ...
            isClearable
            classNamePrefix="ai-analysis-monthly-rollup-company"
          />
        </div>
