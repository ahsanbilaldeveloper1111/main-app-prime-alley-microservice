...
export default function GsmSimManagementFilter() {
  ...
  <span  className="text-primary tagClearFilter" onClick={() => setSelectedFilters({})}>Clear Filters</span>
)}            
  <Dropdown>
                            ...
                            <Row>
                                <Col md={5} className="bg-gray-200 p-3 filterBox">
                                      ...
                                      <ul className="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                                            ...
                                            <li>
                                                  <button className="nav-tab-link" data-bs-toggle="pill"  data-bs-target="#v-pills-pane-4" id="v-pills-tab-4" role="tab" aria-controls="v-pills-tab-4" aria-selected="true">
                                                        <span className="ti ti-phone-call"></span>
                                                        <span className="ms-2">Remote Number</span>
                                                  </button>
                                            </li>
      ...
      Both
                                            ...
                                            <div className="tab-pane fade" id="v-pills-pane-3" role="tabpanel" aria-labelledby="v-pills-tab-3">
                                                  ...
                                                  <Card>
                                                              ...
                                                              <Card.Body>
                                                  <div className="form-group mb-2">
                                                        <label className="form-label mb-1">Extension</label>
                                                        <CreatableSelect
                                                        isMulti
