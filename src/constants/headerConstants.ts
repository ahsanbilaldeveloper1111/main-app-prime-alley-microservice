...
export const HEADER_CONSTANTS = {
  ...
  PERMISSIONS: {
    ...
    VIEW_ACCOUNT_NOTIFICATION_PROFILES:
      "view-account-notification-profiles-general",
    ...
    VIEW_EMPLOYEES_ONBOARDING_STAFF_MANAGEMENT:
      "view-employees-onboarding-staff-management",
    VIEW_EMPLOYEES_APPROVAL_REQUEST_STAFF_MANAGEMENT:
      "view-approval-request-staff-management",
    VIEW_EMPLOYEES_ORGANIZATIONAL_CHART_STAFF_MANAGEMENT:
    ...
    CALL_STATS_BY_COUNTRY_REPORTS: "call-stats-by-country-reports",
    CALL_STATS_BY_DEPARTMENT_REPORTS: "call-stats-by-department-reports",
    CALL_STATS_BY_EXTENSION_REPORTS: "call-stats-by-extension-reports",
    CALL_STATS_BY_DEPARTMENT_EXTENSION_REPORTS:
      "call-stats-by-department-extension-reports",
    GENERAL_CALL_STATISTICS_REPORTS: "general-call-statistics-reports",
    CALL_INCOMING_BY_COUNTRY_REPORTS: "call-incoming-by-country-reports",
    CALL_INCOMING_BY_DEPARTMENT_REPORTS: "call-incoming-by-department-reports",
    CALL_INCOMING_BY_EXTENSION_REPORTS: "call-incoming-by-extension-reports",
    ...
    CAN_CHANGE_USER_STATUS_TMS: "can-change-user-status-tms",
    CAN_FORCE_SIGN_OUT_TMS: "can-force-logout-tms",
    CAN_CHANGE_CAMPAIGN_STATUS_TMS: "can-change-campaign-status-tms",
    CAN_CHANGE_CAMPAIGN_TIMING_TMS: "can-change-campaign-timing-tms",
    VIEW_CAMPAIGN_AGENT: "can-view-campaign-agent-campaign-agent",
    ...
    CREATE_CRM_CAMPAIGNS: "add-crm-campaigns",
    EDIT_CRM_CAMPAIGNS: "edit-crm-campaigns",
    ...
    EDIT_CRM_OPPORTUNITIES: "edit-crm-opportunities",
    DELETE_CRM_OPPORTUNITIES: "delete-crm-opportunities",
    MARK_AS_LOST_CRM_OPPORTUNITIES: "mark-as-lost-crm-opportunities",
    VIEW_CRM_LEADS: "view-crm-leads",
    CREATE_CRM_LEADS: "add-crm-leads",
    EDIT_CRM_LEADS: "edit-crm-leads",
    DELETE_CRM_LEADS: "delete-crm-leads",
    MARK_AS_LOST_CRM_LEADS: "mark-as-lost-crm-leads",
    ADD_FOLLOW_UP_CRM_LEADS: "add-follow-up-crm-leads",
    ADD_MEETING_CRM_LEADS: "add-meeting-crm-leads",

    VIEW_CRM_DEALS: "view-crm-deals",
    CREATE_CRM_DEALS: "add-crm-deals",
    EDIT_CRM_DEALS: "edit-crm-deals",
    DELETE_CRM_DEALS: "delete-crm-deals",
    ADD_MEETING_CRM_DEALS: "add-meeting-crm-deals",
    ...
    EDIT_CRM_TASKS: "edit-crm-tasks",
    DELETE_CRM_TASKS: "delete-crm-tasks",
    VIEW_CRM_PRODUCTS: "view-crm-products",
    CREATE_CRM_PRODUCTS: "add-crm-products",
    EDIT_CRM_PRODUCTS: "edit-crm-products",
    DELETE_CRM_PRODUCTS: "delete-crm-products",
    VIEW_CRM_STAGES: "view-crm-stages",
    CREATE_CRM_STAGES: "add-crm-stages",
    EDIT_CRM_STAGES: "edit-crm-stages",
    DELETE_CRM_STAGES: "delete-crm-stages",
    VIEW_CRM_LOST_REASONS: "view-crm-lost-reasons",
    CREATE_CRM_LOST_REASONS: "add-crm-lost-reasons",
    EDIT_CRM_LOST_REASONS: "edit-crm-lost-reasons",
    DELETE_CRM_LOST_REASONS: "delete-crm-lost-reasons",
    ...
    DELETE_CRM_INDUSTRY: "delete-crm-industry",
