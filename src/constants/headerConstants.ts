...
export const HEADER_CONSTANTS = {
  ...
  PERMISSIONS: {
    ...
    VIEW_INBOUND_CAMPAIGNS_INBOUND: "view-inbound-campaigns-inbound",
    CREATE_INBOUND_CAMPAIGNS_INBOUND: "create-inbound-campaigns-inbound",
    EDIT_INBOUND_CAMPAIGNS_INBOUND: "edit-inbound-campaigns-inbound",
    DELETE_INBOUND_CAMPAIGNS_INBOUND: "delete-inbound-campaigns-inbound",
    ...
    VIEW_OUTBOUND_CONVERSATIONS_OUTBOUND: "view-outbound-conversations-outbound",
