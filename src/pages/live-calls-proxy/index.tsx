...
import useCtiStompProxy from '../../hooks/useCtiStompProxy'
...
const LiveCallDashboard = () => {
  ...
  return (
    <React.Fragment>
      ...
      <BreadcrumbItem mainTitle="CTI" mainLink="/cti" subTitle="Live Calls (Proxy)" showPageLoader={showPageLoader} />
            ...
            <Col md={12}>
                ...
                <Row className="d-flex justify-content-between align-items-center">
                    <Col md={5}>
                      ...
                      <h2 className="mb-0">Live View (Proxy Connection)</h2>
                    </Col>
