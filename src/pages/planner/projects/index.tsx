  ...
  return (
    <React.Fragment>
      <BreadcrumbItem
        mainTitle=""
        mainLink=""
        subTitle="Work Planner Projects"
      />
      ...
      >
        <div
          className="orders-scrollable-content planner-projects-scrollable-content"
          style={{ flex: 1, height: "100%", overflowY: "hidden" }}
        >
          <div
            className="wp-planner-projects"
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  className="wp-planner-projects__layout"
                  style={{ flex: 1, minHeight: 0, display: "flex" }}
                >
                  <div
                    className="wp-planner-projects__main orders-table-wrapper"
                    style={{
                      flex: 1,
                  ...
                  >
                    <ExpandableProjectTable
                      ...
                      loading={p.loading}
                      extensions={
                        (p.hierarchyDataExtensions as PlannerTaskSidebarExtension[]) ||
                        []
                      }
                      sessionPlannerProjectCrud={p.sessionPlannerProjectCrud}
                      sessionUserPhoneOrExtension={
                        p.sessionUserPhoneOrExtension
                      }
                      ...
                      onPaginationChange={(page, rowsPerPage) =>
                        p.setPagination((prev: ProjectPaginationState) => ({
                          ...prev,
