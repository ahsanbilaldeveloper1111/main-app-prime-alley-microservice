...
const Resources = () => {
  ...
  return (
    <React.Fragment>
      ...
      <PageHeader title="Resources" leftGrid={12} />
          ...
          <Card>
            ...
            <Card.Body>
              <Accordion
                activeKey={activeKey}
                onSelect={(eventKey) =>
                  handleAccordionToggle(eventKey as string | null)
                }
              >
                  ...
                  <div className="d-flex align-items-start">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="text-muted mb-3">
                        Complete step-by-step guide to help you get started with
                        all features.
                      </p>
                ...
                <Col md={6} className="mb-4">
                  <div className="d-flex align-items-start">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="text-muted mb-3">
                        Technical documentation for developers and API
                        integration.
                      </p>
                      <Button
                        variant="warning"
                ...
                <Col md={6} className="mb-4">
                  <div className="d-flex align-items-start">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <p className="text-muted mb-3">
                        Interactive courses to enhance your skills and
                        knowledge.
                      </p>
