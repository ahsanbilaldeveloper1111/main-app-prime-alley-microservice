...
interface CreateLdapUserFormProps {
  ...
  handleCreateFormChange: (
    field: keyof CreateUpdateLdapUserParams,
    value: any,
  ) => void;
  errors: any;
  touched: any;
        ...
        <form id="create-ldap-user">
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <Select
                      value={
                        companyOptions.find(
                          (option) =>
                            option.label === verifyLdapUserFormData.companyName,
                        ) || null
                      }
                  ...
                  <div className="input-group">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        handleCreateFormChange("userId", valueWithoutSpaces);
                      }}
                    />
                    <span
            ...
            {!userData?.data?.company_id && !isUpdateMode && (
              <div className="col-sm-6">
                <Form.Group className="mb-3">
                  ...
                  <Select
                    value={
                      availableExtensionsOptions.find(
                        (option) =>
                          option.value ===
                    ...
                    isClearable
                    className={
                      touched.extensionNumber && errors.extensionNumber
                        ? "is-invalid"
                        : ""
                    }
                    menuPortalTarget={document.body}
              ...
              <Form.Group className="mb-3">
                ...
                <Select
                  value={
                    countryOptions.find(
                      (option) =>
                        option.value === verifyLdapUserFormData.country,
                    ) || null
                  }
                  onChange={(selectedOption: any) =>
                    handleCreateFormChange(
            ...
            <div className="col-sm-6">
              <Form.Group className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleCreateFormChange("jobTitle", e.target.value)
                  }
                />
                  ...
                  <div className="input-group">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        handleCreateFormChange("password", randomPassword);
                      }}
                    >
                      Generate Random
                    </Button>
          ...
          <div className="text-end mt-3">
            <Button
              variant="primary"
              onClick={onSubmit}
              disabled={getCurrentLoadingState(1) || !canProceedToNext(1)}
            >
