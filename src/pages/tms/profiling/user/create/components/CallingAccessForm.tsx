...
interface CallingAccessFormProps {
        ...
        >
            ...
            >
                <div className="d-flex align-items-center">
                    <h5 className="mb-0 text-white"> Add Calling Access</h5>
            ...
            <Card.Body
                className={
                    !completedSteps.has(1) || hasPreviousStepChanges
                        ? "opacity-50"
                        : ""
                }
            >
                <form id="calling-access-form">
                    <div className="row">
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <div className="form-check form-switch">
                                    ...
                                    {errors.allow_dncr && touched.allow_dncr && (
                                        <div className="text-danger small mt-1">{errors.allow_dncr}</div>
                                    )}
                                </div>
                            </Form.Group>
                        </div>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <div className="form-check form-switch">
                                        ...
                                        {errors.allow_fac_info && touched.allow_fac_info && (
                                            <div className="text-danger small mt-1">{errors.allow_fac_info}</div>
                                        )}
                                    </div>
                                </Form.Group>
                            </div>
                        ...
                        {companyData?.data?.profile?.mobile_user == MobileUser.Yes && (
                            <div className="col-sm-6">
                                <Form.Group className="mb-3">
                                    ...
                                    <div className="form-check form-switch">
                                        ...
                                        {errors.mobile_user && touched.mobile_user && (
                                            <div className="text-danger small mt-1">{errors.mobile_user}</div>
                                        )}
                                    </div>
                                </Form.Group>
                            </div>
                        ...
                        {verifyUserInfoFormData.mobile_user == MobileUser.Yes && (
                            <div className="col-sm-6">
                                <Form.Group className="mb-3">
                                    ...
                                    <Select
                                        value={deviceTypeOptions.find((option) => option.value === verifyUserInfoFormData.device_type) || null}
                                        onChange={(selectedOption: any) => handleVerifyUserInfoChange("device_type", selectedOption?.value || "")}
                                    ...
                                    {errors.device_type && touched.device_type && (
                                        <div className="text-danger small mt-1">{errors.device_type}</div>
                                    )}
                                </Form.Group>
                            </div>
                        )}

                        {companyData?.data?.profile?.allow_gsm && (
                            <div className="col-sm-6">
                                <Form.Group className="mb-3">
                                    <Form.Label>ICCID</Form.Label>
                                    <Select
                                        value={iccidOptions.find((option) => option.value === verifyUserInfoFormData.iccid_number) || null}
                                        onChange={(selectedOption: any) => handleVerifyUserInfoChange("iccid_number", selectedOption?.value || "")}
                                    ...
                                    {errors.iccid_number && touched.iccid_number && (
                                        <div className="text-danger small mt-1">{errors.iccid_number}</div>
                                    )}
                                </Form.Group>
                            </div>
                        )}
                        ...
                        <div className="col-sm-6">
                            <Form.Group className="mb-3">
                                ...
                                <select
                                    ...
                                    value={verifyUserInfoFormData.shareLineAppearanceCssName || ""}
                                    onChange={(e) =>
                                        handleVerifyUserInfoChange(
                                ...
                                {errors.shareLineAppearanceCssName && touched.shareLineAppearanceCssName && (
                                    <div className="text-danger small mt-1">{errors.shareLineAppearanceCssName}</div>
                                )}
                            </Form.Group>
                        </div>
                        ...
                        <div className="col-sm-6">
                            <Form.Group className="mb-3">
                                ...
                                {errors.call_repetition && touched.call_repetition && (
                                    <div className="text-danger small mt-1">{errors.call_repetition}</div>
                                )}
                            </Form.Group>
                        </div>
                                ...
                                <div className="col-sm-6">
                                    <Form.Group className="mb-3">
                                        ...
                                        <input
                                            ...
                                            disabled={!completedSteps.has(1)}
                                        />
                                        {errors.call_repetition_weekly && touched.call_repetition_weekly && (
                                            <div className="text-danger small mt-1">{errors.call_repetition_weekly}</div>
                                        )}
                                    </Form.Group>
                                </div>
                                <div className="col-sm-6">
                                    <Form.Group className="mb-3">
                                        ...
                                        <input
                                            ...
                                            disabled={!completedSteps.has(1)}
                                        />
                                        {errors.call_repetition_daily && touched.call_repetition_daily && (
                                            <div className="text-danger small mt-1">{errors.call_repetition_daily}</div>
                                        )}
                                    </Form.Group>
                                </div>
                            </>
