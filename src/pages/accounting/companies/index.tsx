          ...
          <div className="form-group mb-3">
            <div className="form-check mt-4">
              <input
                ...
                onChange={(e) => onCardDataChange("isDefault", e.target.checked)}
              />
      ...
      <div className="row">
        <div className="col-12">
          <div className="form-group mb-3">
            ...
            <div className={`border rounded p-3 ${cardError ? 'border-danger' : isCardComplete ? 'border-success' : ''}`}>
              <CardElement
                options={{
                  style: {
                    base: {
      ...
      <div className="row">
        <div className="col-12">
          <Button
            type="submit"
            variant="primary"
            disabled={isSavingCard || !stripe || !isCardComplete || !cardData.cardholderName.trim()}
          >
...
const CompanyList = () => {
  ...
  // Handle edit company
  const handleEditCompany = useCallback(async (company: CompanyData) => {
    ...
    try {
      ...
      setFormData({
        ...
        profile: {
          ...
          discount_type: freshCompanyData.profile?.discount_type ?? "flat_percentage",
          address: freshCompanyData.profile?.address ?? "",
          discount_limit: freshCompanyData.profile?.discount_limit?.toString() ?? "0.00",
          discount_applicability: freshCompanyData.profile?.discount_applicability ?? [] as string[],
          payment_methods: freshCompanyData.profile?.payment_methods ?? [] as string[],
          payment_mode: freshCompanyData.profile?.payment_mode ?? "one_time",
          credit_limit: freshCompanyData.profile?.credit_limit?.toString() ?? "0.00",
          early_payment_discount: freshCompanyData.profile?.early_payment_discount?.toString() ?? "0.00",
          late_fee_rule: freshCompanyData.profile?.late_fee_rule?.toString() ?? "0.00",
          payment_terms: Number(freshCompanyData.profile?.payment_terms) || 30,
          outstanding_invoices: freshCompanyData.profile?.outstanding_invoices?.toString() ?? "0.00",
          discounts_applied_ytd: freshCompanyData.profile?.discounts_applied_ytd?.toString() ?? "0.00",
          vat_collected: freshCompanyData.profile?.vat_collected?.toString() ?? "0.00",
          active_subscriptions: freshCompanyData.profile?.active_subscriptions?.toString() ?? "0",
          last_refund_date: freshCompanyData.profile?.last_refund_date ?? "",
          profile_status: freshCompanyData.profile?.profile_status ?? "incomplete",
          selected_products: freshCompanyData.profile?.selected_products ?? [] as string[]
        }
      });
  ...
  const handleSaveCard = useCallback(async (stripeToken: string) => {
    ...
    <React.Fragment>
        ...
        <div className="row">
            <div className="col-12">
              ...
              <div className="tab-content" id="createCompanyTabsContent">
                ...
                <div className={`tab-pane fade ${activeTab === "basic-info" ? "show active" : ""}`} id="create-basic-info" role="tabpanel" aria-labelledby="create-basic-info-tab">
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        ...
                        <select
                          ...
                          onChange={(e) => handleInputChange("reseller_id", e.target.value)}
                        >
                ...
                <div className={`tab-pane fade ${activeTab === "profile" ? "show active" : ""}`} id="create-profile" role="tabpanel" aria-labelledby="create-profile-tab">
                  <div className="row mt-3">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        ...
                        <select
                          ...
                          onChange={(e) => handleProfileInputChange("currency", e.target.value)}
                        >
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        ...
                        <input
                          ...
                          onChange={(e) => handleProfileInputChange("vat_rate", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                      ...
                      <div className="form-group mb-3">
                        <div className="form-check mt-4">
                          <input
                            ...
                            onChange={(e) => handleProfileInputChange("vat_exemption", e.target.checked)}
                          />
                          <label className="form-check-label" htmlFor="createVatExemption">
                            VAT Exemption
                          </label>
                        </div>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createProfileStatus">Profile Status</label>
                        <select
                          className="form-control"
                          id="createProfileStatus"
                          value={formData.profile.profile_status}
                          onChange={(e) => handleProfileInputChange("profile_status", e.target.value)}
                        >
                ...
                {/* Payment & Billing Tab */}
                <div className={`tab-pane fade ${activeTab === "payment" ? "show active" : ""}`} id="create-payment" role="tabpanel" aria-labelledby="create-payment-tab">
                  <div className="row mt-3">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createPaymentMode">Payment Mode</label>
                        <select
                          className="form-control"
                          id="createPaymentMode"
                          value={formData.profile.payment_mode}
                          onChange={(e) => handleProfileInputChange("payment_mode", e.target.value)}
                        >
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createPaymentTerms">Payment Terms (Days)</label>
                        <input
                          type="number"
                          className="form-control"
                          id="createPaymentTerms"
                          value={formData.profile.payment_terms}
                          onChange={(e) => handleProfileInputChange("payment_terms", parseInt(e.target.value) || 0)}
                          placeholder="30"
                        />
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createCreditLimit">Credit Limit</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                          ...
                          onChange={(e) => handleProfileInputChange("credit_limit", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createOutstandingInvoices">Outstanding Invoices</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                          ...
                          onChange={(e) => handleProfileInputChange("outstanding_invoices", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createActiveSubscriptions">Active Subscriptions</label>
                        <input
                          type="number"
                          className="form-control"
                          id="createActiveSubscriptions"
                          value={formData.profile.active_subscriptions}
                          onChange={(e) => handleProfileInputChange("active_subscriptions", e.target.value)}
                          placeholder="0"
                        />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createLastRefundDate">Last Refund Date</label>
                        <input
                          type="date"
                          className="form-control"
                          id="createLastRefundDate"
                          value={formData.profile.last_refund_date}
                          onChange={(e) => handleProfileInputChange("last_refund_date", e.target.value)}
                        />
                      </div>
                    </div>
                  </div>
                ...
                {/* Discounts & Terms Tab */}
                <div className={`tab-pane fade ${activeTab === "discounts" ? "show active" : ""}`} id="create-discounts" role="tabpanel" aria-labelledby="create-discounts-tab">
                  <div className="row mt-3">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        ...
                        <select
                          ...
                          onChange={(e) => handleProfileInputChange("discount_type", e.target.value)}
                        >
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createDiscountLimit">Discount Limit (%)</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                          ...
                          onChange={(e) => handleProfileInputChange("discount_limit", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createEarlyPaymentDiscount">Early Payment Discount (%)</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                          ...
                          onChange={(e) => handleProfileInputChange("early_payment_discount", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createLateFeeRule">Late Fee Rule (%)</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                          ...
                          onChange={(e) => handleProfileInputChange("late_fee_rule", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createDiscountsAppliedYtd">Discounts Applied YTD</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                          ...
                          onChange={(e) => handleProfileInputChange("discounts_applied_ytd", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="createVatCollected">VAT Collected</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                          ...
                          onChange={(e) => handleProfileInputChange("vat_collected", e.target.value)}
                          placeholder="0.00"
                        />
                      </div>
                    </div>
      ...
      <FormModal
        ...
        {isLoadingCompany ? (
            ...
            <div className="row">
              <div className="col-12">
                <ul className="nav nav-tabs" id="editCompanyTabs" role="tablist">
                <li className="nav-item" role="presentation">
                  <button
                    className={`nav-link ${activeTab === "basic-info" ? "active" : ""}`}
                    id="basic-info-tab"
              ...
              <div className="tab-content" id="editCompanyTabsContent">
                {/* Basic Information Tab */}
                <div className={`tab-pane fade ${activeTab === "basic-info" ? "show active" : ""}`} id="basic-info" role="tabpanel" aria-labelledby="basic-info-tab">
                  <div className="row mt-3">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                ...
                <div className={`tab-pane fade ${activeTab === "profile" ? "show active" : ""}`} id="profile" role="tabpanel" aria-labelledby="profile-tab">
                      ...
                      <div className="form-group mb-3">
                        <div className="form-check mt-4">
                          <input
                            ...
                            onChange={(e) => handleProfileInputChange("vat_exemption", e.target.checked)}
                          />
                          <label className="form-check-label" htmlFor="editVatExemption">
                            VAT Exemption
                          </label>
                        </div>
                      </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editProfileStatus">Profile Status</label>
                        <select
                          className="form-control"
                ...
                <div className={`tab-pane fade ${activeTab === "payment" ? "show active" : ""}`} id="payment" role="tabpanel" aria-labelledby="payment-tab">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editOutstandingInvoices">Outstanding Invoices</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editActiveSubscriptions">Active Subscriptions</label>
                        <input
                          type="number"
                          className="form-control"
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editLastRefundDate">Last Refund Date</label>
                        <input
                          type="date"
                          className="form-control"
                ...
                <div className={`tab-pane fade ${activeTab === "discounts" ? "show active" : ""}`} id="discounts" role="tabpanel" aria-labelledby="discounts-tab">
                  <div className="row mt-3">
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editDiscountLimit">Discount Limit (%)</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editEarlyPaymentDiscount">Early Payment Discount (%)</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editLateFeeRule">Late Fee Rule (%)</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editDiscountsAppliedYtd">Discounts Applied YTD</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                    ...
                    <div className="col-md-6">
                      <div className="form-group mb-3">
                        <label htmlFor="editVatCollected">VAT Collected</label>
                        <input
                          type="number"
                          step="0.01"
                          className="form-control"
                ...
                {/* Payment Methods Tab */}
                <div className={`tab-pane fade ${activeTab === "payment-methods" ? "show active" : ""}`} id="payment-methods" role="tabpanel" aria-labelledby="payment-methods-tab">
                  <div className="row mt-3">
                    <div className="col-12">
                        ...
                        <div className="card-body">
                          {isLoadingPaymentMethods ? (
                                ...
                                <tbody>
                                  {paymentMethods.map((method) => (
                                    <tr key={method.id}>
                                      ...
                                      <td>
                                        <small className="text-muted">
                                          {moment(method.created_at).format("MMM DD, YYYY")}
                                        </small>
                                      </td>
                                      <td>
                            ...
                            <div className="text-center py-4">
                              ...
                              <small className="text-muted">Add a card above to get started</small>
                            </div>
                          )}
                        </div>
                      </div>
        ...
        <Modal.Body>
          ...
          {importFile && (
            <Alert variant="success">
              ...
              <br />
              <small>Size: {(importFile.size / 1024 / 1024).toFixed(2)} MB</small>
            </Alert>
          )}
