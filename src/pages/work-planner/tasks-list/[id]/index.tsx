...
const TaskDetailPage = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      router.push('/work-planner/tasks-list');
    } catch (err) {
  ...
  if (loading && !task) {
    return (
      <>
        <BreadcrumbItem mainTitle="Work Planner" mainLink="/work-planner/tasks-list" subTitle="Task" />
        ...
        <Container className="py-5">
          <Card>
            <Card.Body className="text-center py-5">
              ...
              <Button variant="primary" onClick={() => router.push('/work-planner/tasks-list')}>
                Back to Tasks
              </Button>
            </Card.Body>
          </Card>
  ...
  return (
    <>
      <BreadcrumbItem
        mainTitle="Work Planner"
        mainLink="/work-planner/tasks-list"
      ...
      <Container className="py-4">
        <div className="d-flex align-items-center gap-2 mb-4">
          <Button
            ...
            size="sm"
            onClick={() => router.push('/work-planner/tasks-list')}
