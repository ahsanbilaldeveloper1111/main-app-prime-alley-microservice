...
const CustomerDashboard = () => {
  ...
  const getDashboardCounters = async () => {
    ...
    setSummaryCards([
      ...
      { title: 'Overdue Amount', value: `${CURRENCY_SYMBOL} ${formatWithOneDecimal(response?.invoices?.overdue_amount)}`, icon: AlertCircle, iconColor: '#fbbf24', iconBgColor: 'rgba(251, 191, 36, 0.1)', link: { text: 'Pay Now', onClick: () => router.push('/finance/invoices') } },
