...
const LiveCallNew = () => {
  ...
  return (
    <React.Fragment>
      <BreadcrumbItem mainTitle="Wallboards (Live)" mainLink="/communications/wallboards-live" subTitle="New" />
        ...
        <Container fluid className="" style={{paddingTop: fullscreen ? '24px' : '0', paddingBottom: '24px', maxWidth: '100%', overflowX: 'hidden'}}>
          ...
          <Row className="mb-3 mb-md-4 g-3" style={{ display: fullscreen ? 'none' : 'flex', paddingTop: '24px' }}>
            <Col xs={12} md={6} lg={5} xl={6}>
              <h2 className="mb-1 fw-bold" style={{ fontSize: 'clamp(1.25rem, 3vw, 1.5rem)', color: '#1f2937' }}>Wallboards (Live)</h2>
