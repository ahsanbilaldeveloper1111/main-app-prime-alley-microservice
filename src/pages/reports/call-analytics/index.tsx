                    ...
                    <div className="report-grid" id="reportGrid">
                        <Row className="">
                           ...
                           {session?.user?.permissions?.includes('call-reports-by-statistics-reports') && (
                            ...
                            <Col md={4}>
                                <a href="/reports/call-analytics/stats/country" className="report-card" >
                            ...
                            <Col md={4}>
                                <a href="/reports/call-analytics/stats/department" className="report-card" >
                                    <div className="report-header">
                                        <span className="material-icons-two-tone report-icon">call</span>
                            ...
                            <Col md={4}>
                                <a href="/reports/call-analytics/stats/extension" className="report-card" >
                                    <div className="report-header">
                                        <span className="material-icons-two-tone report-icon">call</span>
                            ...
                            <Col md={4}>
                                <a href="/reports/call-analytics/stats/department/extension" className="report-card" >
                                    <div className="report-header">
                                        <span className="material-icons-two-tone report-icon">call</span>
                            ...
                            <Col md={4}>
                                <a href="/reports/call-analytics/stats/general" className="report-card" >
                                    <div className="report-header">
                                        <span className="material-icons-two-tone report-icon">call</span>
                            ...
                            <>
                                <Col md={4}>
                                    <a href="/reports/call-analytics/incoming/country" className="report-card" >
                                        <div className="report-header">
                                ...
                                <Col md={4}>
                                    <a href="/reports/call-analytics/incoming/department" className="report-card" >
                                        <div className="report-header">
                                            <span className="material-icons-two-tone report-icon">call_received</span>
                                ...
                                <Col md={4}>
                                    <a href="/reports/call-analytics/incoming/extension" className="report-card" >
                                        <div className="report-header">
                                            <span className="material-icons-two-tone report-icon">call_received</span>
