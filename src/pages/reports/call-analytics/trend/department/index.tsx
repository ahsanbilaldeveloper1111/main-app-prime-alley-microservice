        ...
        const response = await ListCallLogs(
          {
            ...
            reportType: "trendStatsDepartment",
            moduleSlug: ModuleSlug.CALL_REPORTS,
          },
          "call-logs/statsTrendByDepartment",
        ).finally(() => {
  ...
  return (
    <React.Fragment>
      <BreadcrumbItem
        mainTitle=""
        mainLink=""
        subTitle="Call Trend By Department"
...
CallTrendDepartment.getLayout = (page: ReactElement) => {
