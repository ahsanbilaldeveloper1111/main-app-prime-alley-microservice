...
const CallTrendExtension = () => {
  ...
  const columns: Column[] = [
    ...
    },
    {
      key: "CallDate",
      name: "Call Date",
      selector: (row: any) => row.CallDate,
      sortable: true,
    },
    {
      key: "StartHour",
      name: "Start Hour",
      selector: (row: any) => row.StartHour,
      sortable: true,
    },
    ...
    },
    {
      key: "TotalDuration",
      name: "Total Duration",
      selector: (row: any) => row.TotalDuration,
      sortable: true,
    },
    {
      key: "Unanswered",
        ...
        const response = await ListCallLogs(
          {
            ...
            reportType: "trendStatsExtension",
            moduleSlug: ModuleSlug.CALL_REPORTS,
          },
          "call-logs/statsTrendByExtension",
        ).finally(() => {
  ...
  useEffect(() => {
    ...
    const areFiltersReady =
      filtersReady && currentFilters && Object.keys(currentFilters).length > 0;
  ...
  return (
    <React.Fragment>
      <BreadcrumbItem
        mainTitle=""
        mainLink=""
        subTitle="Call Trend By Extension"
