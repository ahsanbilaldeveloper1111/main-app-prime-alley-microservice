...
function DeviceStatusCell(props: Readonly<{ status?: "UP" | "DOWN" }>) {
  const { status } = props;
  return (
...
function DeviceCreatedAtCell(props: Readonly<{ created_at?: string }>) {
...
function renderStatusCell(props: {
  monitoring_status?: "UP" | "DOWN";
  status?: "UP" | "DOWN";
}) {
  return <DeviceStatusCell status={props.monitoring_status ?? props.status} />;
}
...
const Devices = () => {
  ...
  const columns: Column[] = [
    ...
    },
    {
      key: "device_type",
      name: "Device Type",
      selector: (row: any) => row.device_type,
      sortable: true,
    },
    {
      key: "protocol",
      name: "Protocol",
      selector: (row: any) => row.protocol,
      sortable: true,
    },
    {
      key: "port",
  ...
  const fetchDevices = useCallback(
    async (page = 1, perPage = 15, search = "") => {
      try {
        ...
        const mappedDevices: DeviceWithStatus[] = (devicesResponse || []).map(
          (device: Device) => ({
            ...device,
                ...
                {loadingStatuses && statusProgress.total > 0 && (
                  <div className="me-3">
                    <small className="text-muted">
                      ...
                      Loading statuses: {statusProgress.loaded}/
        ...
        formHtml={
          <>
            <div className="row">
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="create-hostname">
                    Hostname *
                  </label>
                  <input
                    id="create-hostname"
              ...
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="create-ip_address">
                    IP Address *
                  </label>
                  <input
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="create-protocol">
                    Protocol *
                  </label>
                  <select
                    id="create-protocol"
              ...
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="create-port">
                    Port *
                  </label>
                  <input
                    id="create-port"
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="create-customer_name">
                    Customer Name *
                  </label>
                  <input
              ...
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="create-device_type">
                    Device Type
                  </label>
                  <select
              ...
              <div className="col-md-12">
                <div className="form-group mb-3">
                  <label
                    ...
                    htmlFor="create-enable_password"
                  >
                    Enable Password
                  </label>
                  <input
        ...
        formHtml={
          <>
            <div className="row">
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="edit-hostname">
                    Hostname *
                  </label>
                  <input
                    id="edit-hostname"
              ...
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="edit-ip_address">
                    IP Address *
                  </label>
                  <input
                    id="edit-ip_address"
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="edit-protocol">
                    Protocol *
                  </label>
                  <select
                    id="edit-protocol"
              ...
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="edit-port">
                    Port *
                  </label>
                  <input
                    id="edit-port"
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="edit-customer_name">
                    Customer Name *
                  </label>
                  <input
              ...
              <div className="col-md-6">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="edit-device_type">
                    Device Type
                  </label>
                  <select
                    id="edit-device_type"
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="form-group mb-3">
                  <label className="form-label" htmlFor="edit-enable_password">
                    Enable Password
                  </label>
                  <input
