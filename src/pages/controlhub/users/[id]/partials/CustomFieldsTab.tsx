...
const CustomFieldsTab: React.FC<CustomFieldsTabProps> = ({
    ...
    const handleSubmitAddCustomField = async () => {
        const response = await AddCustomFields(userId, add_field_name, add_field_value);
        if (response) {
            onCustomFieldsUpdate();
            toast.success('Custom field added successfully');
            onSuccess('Custom Field Added', 'The custom field has been added successfully');
            setShowAddCustomFieldModal(false);
            setAddFieldName('');
            setAddFieldValue('');
        }
    ...
    const handleSubmitEditCustomField = async () => {
        ...
        if (response) {
            ...
            onSuccess('Custom Field Edited', 'The custom field has been edited successfully');
            setShowEditCustomFieldModal(false);
            setEditFieldName('');
            setEditFieldValue('');
            setEditFieldId('');
                        ...
                        formHtml={
                            <>
                                <div className="form-group mb-3">
                                    ...
                                    <input type="text" className="form-control" id="customFieldName" onChange={(e) => setAddFieldName(e.target.value)} value={add_field_name} />
                                ...
                                <div className="form-group mb-3">
                                    ...
                                    <input type="text" className="form-control" id="customFieldValue" onChange={(e) => setAddFieldValue(e.target.value)} value={add_field_value} />
