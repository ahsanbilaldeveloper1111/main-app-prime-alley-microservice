...
export interface MeetingExtensionData {
  id: number;
  meeting_id: number;
  extension: string;
  status: string;
...
export interface MeetingData {
  ...
  created_at: string;
  updated_at: string;
  extensions?: MeetingExtensionData[];
}
...
function extractData<T>(response: any): T {
  ...
  throw new Error(response?.data?.message || response?.message || 'API request failed');
}
...
// Lead Management
export const getLeads = async (params: PaginationParams = {}): Promise<PaginationWrapper<LeadData>> => {
  try {
...
export const createLead = async (data: Partial<LeadData>): Promise<LeadData> => {
  try {
...
export const updateLead = async (id: number, data: Partial<LeadData>): Promise<LeadData> => {
  try {
...
export const convertLead = async (id: number): Promise<LeadData> => {
  try {
    const response = await axiosInstance.post(`/crm/leads/convert`, { lead_id: id });
    return extractData<LeadData>(response.data);
  } catch (error: any) {
...
export const markLeadLost = async (id: number, data: { lost_reason_id: number; lost_feedback?: string }): Promise<LeadData> => {
  try {
    const response = await axiosInstance.post(`/crm/leads/mark-lost`, { lead_id: id, ...data });
    return extractData<LeadData>(response.data);
  } catch (error: any) {
...
export const getLeadsByStage = async (stageId: number, params: PaginationParams = {}): Promise<PaginationWrapper<LeadData>> => {
  try {
    const response = await axiosInstance.get(`/crm/leads/by-stage/${stageId}`, { params });
    return extractData<PaginationWrapper<LeadData>>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to fetch leads by stage');
    throw error;
  }
};

export const getLeadsByType = async (type: 'lead' | 'opportunity', params: PaginationParams = {}): Promise<PaginationWrapper<LeadData>> => {
  try {
    const response = await axiosInstance.get(`/crm/leads/by-type/${type}`, { params });
    return extractData<PaginationWrapper<LeadData>>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to fetch leads by type');
    throw error;
  }
};

// Comments
export const addComment = async (leadId: number, data: { comment: string }): Promise<any> => {
  try {
    const response = await axiosInstance.post(`/crm/leads/${leadId}/comments`, data);
...
export const addAssigneeComment = async (leadId: number, data: { comment: string }): Promise<any> => {
  try {
    const response = await axiosInstance.post(`/crm/leads/${leadId}/assignee-comments`, data);
    return extractData<any>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to add assignee comment');
    throw error;
  }
};
...
export const getAssigneeComments = async (leadId: number): Promise<any[]> => {
  try {
    const response = await axiosInstance.get(`/crm/leads/${leadId}/assignee-comments`);
    return extractData<any[]>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to fetch assignee comments');
    throw error;
  }
};
...
export const getStages = async (): Promise<StageData[]> => {
  try {
    ...
    toast.error(error.response?.data?.message || 'Failed to fetch stages');
    throw error;
  }
};

export const createStage = async (data: Partial<StageData>): Promise<StageData> => {
  try {
...
export const updateStage = async (id: number, data: Partial<StageData>): Promise<StageData> => {
  try {
...
export const getLostReasons = async (): Promise<LostReasonData[]> => {
  try {
    ...
    toast.error(error.response?.data?.message || 'Failed to fetch lost reasons');
    throw error;
  }
};

export const createLostReason = async (data: Partial<LostReasonData>): Promise<LostReasonData> => {
  try {
    const response = await axiosInstance.post('/crm/lost-reasons', data);
    return extractData<LostReasonData>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to create lost reason');
    throw error;
  }
};

export const updateLostReason = async (id: number, data: Partial<LostReasonData>): Promise<LostReasonData> => {
  try {
    const response = await axiosInstance.put(`/crm/lost-reasons/${id}`, data);
    return extractData<LostReasonData>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to update lost reason');
    throw error;
  }
};
...
export const deleteLostReason = async (id: number): Promise<void> => {
  try {
    ...
    toast.error(error.response?.data?.message || 'Failed to delete lost reason');
    throw error;
  }
};

export const getLostLeads = async (params: PaginationParams = {}): Promise<PaginationWrapper<LeadData>> => {
  try {
    const response = await axiosInstance.get('/crm/lost-leads', { params });
    return extractData<PaginationWrapper<LeadData>>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to fetch lost leads');
    throw error;
  }
};

// Meeting Management
export const getMeetings = async (params: { lead_id?: number; extension?: string } = {}): Promise<MeetingData[]> => {
  try {
...
export const createMeeting = async (data: Partial<MeetingData>): Promise<MeetingData> => {
  try {
    const response = await axiosInstance.post('/crm/meetings', data);
    return extractData<MeetingData>(response.data);
  } catch (error: any) {
...
export const getMeeting = async (id: number): Promise<MeetingData> => {
  try {
    ...
    toast.error(error.response?.data?.message || 'Failed to fetch meeting');
    throw error;
  }
};

export const updateMeeting = async (id: number, data: Partial<MeetingData>): Promise<MeetingData> => {
  try {
    const response = await axiosInstance.put(`/crm/meetings/${id}`, data);
    return extractData<MeetingData>(response.data);
  } catch (error: any) {
...
export const getMeetingsByExtension = async (extension: string): Promise<MeetingData[]> => {
  try {
    const response = await axiosInstance.get('/crm/meetings/by-extension', { params: { extension } });
    return extractData<MeetingData[]>(response.data);
  } catch (error: any) {
    toast.error(error.response?.data?.message || 'Failed to fetch meetings by extension');
    throw error;
  }
};

// Opportunity Management
export const getOpportunities = async (params: PaginationParams = {}): Promise<PaginationWrapper<OpportunityData>> => {
  try {
...
export const createOpportunity = async (data: Partial<OpportunityData>): Promise<OpportunityData> => {
  try {
...
export const updateOpportunity = async (id: number, data: Partial<OpportunityData>): Promise<OpportunityData> => {
  try {
